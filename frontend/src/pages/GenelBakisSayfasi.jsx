...
Done
Bunu kopyalayıp frontend/src/pages/BankaKasaSayfasi.jsx dosyasının tüm içeriğini bununla değiştir.

Uygulama sırası
backend/app/schemas/raporlama.py → sona 2 class ekle
backend/app/routers/raporlama.py → tam değiştir
backend/app/routers/banka.py → tam değiştir
frontend/src/pages/GenelBakisSayfasi.jsx → tam değiştir
frontend/src/pages/BankaKasaSayfasi.jsx → tam değiştir
Commit edip deploy'u bekle. Sonuçları:

Banka/Kasa artık iki sekme: "Hesaplar" (hesap ekleme/düzenleme/silme) ve "Hareketler" (banka + kasa hareketlerini ayrı ayrı görüp yeni hareket ekleyebileceğin yer)
Genel Bakış'a eklenenler: "Depo toplam değeri" metriği, ürün türüne göre depo listesi (adet + toplam maliyet değeri), banka bakiyeleri listesi, aktif kiralamalar listesi (kime, ne kadara)
Kalan iş: Raporlar sayfası (tarih/ürün/müşteri bazında filtreleme). Bunun için frontend/src/pages/RaporlarSayfasi.jsx dosyasının şu anki tam içeriğini paylaşır mısın? Onu görünce, en uygun şekilde (muhtemelen üç filtre modu: "Tarih aralığı", "Ürün (seri no)", "Müşteri/Cari" seçilip ilgili tabloyu gösteren bir arayüz) tasarlayıp tamamlayacağım.
