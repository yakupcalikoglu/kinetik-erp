...
const HAREKET_TUR_METIN = { SATIS: 'Satış', KIRALAMA: 'Kiralama', LEASING: 'Leasing', BAKIM: 'Bakım', TAKSITLI_SATIS: 'Taksitli Satış', POS_TAKSIT: 'Kredi Kartı Taksitli', CEK: 'Çek', SIPARIS: 'Sipariş', TEDARIKCI_FATURA: 'Tedarikçi Faturası' };
const HAREKET_TUR_TON = { SATIS: 'yesil', KIRALAMA: 'amber', LEASING: 'kirmizi', BAKIM: 'notr', TAKSITLI_SATIS: 'amber', POS_TAKSIT: 'yesil', CEK: 'notr', SIPARIS: 'notr', TEDARIKCI_FATURA: 'kirmizi' };
...
const CARI_HAREKET_YOL_HARITASI = {
  ...
  POS_TAKSIT: '/finansal?sekme=postaksit',
