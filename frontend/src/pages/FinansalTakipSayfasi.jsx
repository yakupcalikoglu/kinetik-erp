...
const SEKME_GRUPLARI = [
  ...
  },
  {
    ...
    aciklama: 'Çek, kredi kartı ve ortak/dış borç',
    sekmeler: [
      { deger: 'cek', etiket: 'Çek', bilgi: 'Alınan veya verilen çeklerin portföy takibi — tahsil/ödeme, ciro işlemleri.' },
      { deger: 'postaksit', etiket: 'Kredi Kartı Taksitleri', bilgi: 'Müşterinin kredi kartıyla taksitli ödediği satışlar — satış anında tamamlanır, banka tutarı size her ay parça parça yatırır. Buradan her taksidin gerçekten hesaba yatıp yatmadığını işaretlersiniz.' },
