...
class AkreditifKalemi(Base):
    ...
    tutar = Column(Numeric(18, 2), nullable=False)
    # Bu kalem icin SIMDIYE KADAR fiilen odenen toplam - kismi odemeleri
    # dogru takip edebilmek icin (odendi_mi SADECE odenen_tutar >= tutar
    # oldugunda True olur). Taksitlendirilmis kalemlerde bu alan kullanilmaz,
    # onun yerine AkreditifKalemTaksiti satirlari kullanilir.
