...
from app.routers import auth, sirketler, cari, stok, siparis, banka, finansal, diger, raporlama, yetki, akreditif, virman, harcama_turu, kaynak_detay, yedek_parca, arama, demirbas, tedarikci_fatura, belge
app = FastAPI(
